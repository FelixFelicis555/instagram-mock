...
export class Content extends React.Component<IContentProps,IContentStates>{
    ...
    render() {
        ...
        const Images=this.props.posts.map(post=>(
            <Tile userInfo={this.props.userInfo} key={++count} post={post} increaseLike={this.props.increaseLike} addComment={this.props.addComment} deletePost={this.props.deletePost}></Tile>
        ))
      return(
